...
**Output filename format**: `<serial>.cfg`

**Example**: `ABC123456789.cfg`
...
python juniper_excel_to_config.py juniper_config_template.xlsx
```
Creates: `<serial>.cfg` (e.g., `ABC123456789.cfg`)
...
scp <serial>.cfg admin@switch:/var/tmp/

# On switch:
configure
load set /var/tmp/<serial>.cfg
commit check
commit and-quit
```
